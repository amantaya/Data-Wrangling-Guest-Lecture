...
2. Show students how to download code as
...
6. Walk through cleaning messy data script [cleaning_messy_data.R](scripts/cleaning_messy_data.R)
7. Walk through analyzing clean data script [analyzing_clean_data.R](scripts/analyzing_clean_data.R)
